...
business_lines = c("wkcomp", "othliab")
business_lines = c("wkcomp")
#business_lines = c("medmal","ppauto","prodliab", "wkcomp")
#business_lines = c("comauto")
#business_lines = c("othliab")
```
...
* GP on Incremental Loss Ratios  with hurdle model using multi-company model
